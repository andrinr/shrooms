...
(function(root){
 ...
 function create(storage){
  ...
  function write(spots){if(spots.length>limit)throw Error('Your notebook can hold up to 500 spots.');storage.setItem(key,JSON.stringify({version:1,spots}));return spots;}
